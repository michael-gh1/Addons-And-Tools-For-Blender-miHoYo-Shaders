...
def rig_character(
    ...
    allow_back_move = True

    # Interesting thing here. Sometimes, character only have a short "skirt" at the front, that makes no sense in moving back with the leg.
    def identify_front_skirt():
        for this_skirt_bone in front_skirt_bones:
            if this_skirt_bone[-1] == "3":
                allow_back_move = True

           
    def identify_front_skirt2():
        global allow_back_move
        distance_allowed = 0.03
        bpy.ops.object.mode_set(mode='EDIT') 
        dist = []
        if allow_back_move:
            for this_skirt_bone in front_skirt_bones:
                if this_skirt_bone[-1] == "2":
                    temp2 = this_skirt_bone
                    temp1 = temp2[:-1] + "1"
                    try:
                        distance = abs(armature.edit_bones[temp2].head[1] - armature.edit_bones[temp1].tail[1])
            ...
            print("avg: " + str(avg))
            if avg < distance_allowed:
                allow_back_move = False
        bpy.ops.object.mode_set(mode='POSE')             
                    
                    


    #identify_front_skirt2()
    #identify_front_skirt()
            ...
            if " CF " in bone_name:
                if bone_name[-1] == "1":
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Left Leg", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="X", t_min_x=calc(-0.125), t_max_x=calc(0.125), t_min_y=calc(0.5), t_max_y=calc(-0.5), t_min_z=calc(0), t_max_z=calc(0))
                        add_const(bone_name, "Right Leg", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="Z", t_min_x=calc(-0.125), t_max_x=calc(0.125), t_min_y=calc(-0.5), t_max_y=calc(0.5), t_min_z=calc(0), t_max_z=calc(0))
                    ...
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Left Leg", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="X", t_min_x=calc(0.125,True), t_max_x=calc(-0.125,True), t_min_y=calc(0.5,True), t_max_y=calc(-0.5,True), t_min_z=calc(-0.125,True), t_max_z=calc(0.125,True))
                        add_const(bone_name, "Right Leg", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="X", t_min_x=calc(0.125), t_max_x=calc(-0.125), t_min_y=calc(-0.5), t_max_y=calc(0.5), t_min_z=calc(0.125), t_max_z=calc(-0.125))
                    ...
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Left Leg", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="X", t_min_x=calc(0), t_max_x=calc(0), t_min_y=calc(0.5,True), t_max_y=calc(-0.5,True), t_min_z=calc(0.125,True), t_max_z=calc(-0.125,True))
                        add_const(bone_name, "Right Leg", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="X", map_z="Z", t_min_x=calc(0), t_max_x=calc(0), t_min_y=calc(-0.5,True), t_max_y=calc(0.5,True), t_min_z=calc(0), t_max_z=calc(0))
            # Front Left
            elif " L " in bone_name:
                if bone_name[-1] == "1":
                    if allow_back_move:
                        ...
                        add_const(bone_name, "X+", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(-0.75,True), t_max_x=calc(0.75,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
                        add_const(bone_name, "X-", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(-0.3,True), t_max_x=calc(0.3,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
                        add_const(bone_name, "Z+", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", f_min_x=0, f_max_x=0, f_min_z=calc(-1), f_max_z=calc(1), map_x="X", map_y="Y", map_z="Z", t_min_x=calc(0), t_max_x=calc(0), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(-0.1,True), t_max_z=calc(0.1,True))
                    ...
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Transformation", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="X", t_min_x=calc(0.25,True), t_max_x=calc(-0.25,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0.125,True), t_max_z=calc(0.0))
                elif bone_name[-1] == "3":
                    if allow_back_move:    
                        ...
                        add_const(bone_name, "Transformation", "DEF-thigh.L", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(0.25,True), t_max_x=calc(-0.25,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
            ...
            # Front Right
                ...
                if bone_name[-1] == "1":
                    if allow_back_move:
                        ...
                        add_const(bone_name, "X+", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(-0.75,True), t_max_x=calc(0.75,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
                        add_const(bone_name, "X-", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(-0.3,True), t_max_x=calc(0.3,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
                        add_const(bone_name, "Z+", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", f_min_x=0, f_max_x=0, f_min_z=calc(-1), f_max_z=calc(1), map_x="X", map_y="Y", map_z="Z", t_min_x=calc(0), t_max_x=calc(0), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(-0.1), t_max_z=calc(0.1,True))
                    ...
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Transformation", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="X", t_min_x=calc(0.25,True), t_max_x=calc(-0.25,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(-0.125,True), t_max_z=calc(0))
                elif bone_name[-1] == "3":    
                    if allow_back_move:
                        ...
                        add_const(bone_name, "Transformation", "DEF-thigh.R", "1 / (1 + exp(-6 * (bone*-1)))", map_x="X", map_y="Y", map_z="Z", t_min_x=calc(0.25,True), t_max_x=calc(-0.25,True), t_min_y=calc(0), t_max_y=calc(0), t_min_z=calc(0), t_max_z=calc(0))
        # SIDE
        elif area == "SIDE": 
            # Side Left
            if " L " in bone_name:
